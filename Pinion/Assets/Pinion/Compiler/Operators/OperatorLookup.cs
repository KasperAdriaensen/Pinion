...
namespace Pinion.Compiler.Internal
{
	public static class OperatorLookup
	{
		...
		private static Dictionary<string, OperatorInfo> operatorsToInstructions = new Dictionary<string, OperatorInfo>
		{
		...
		public static OperatorInfo GetOperatorInfo(string token)
		{
		...
		{
			foreach (KeyValuePair<string, OperatorInfo> operatorInfo in operatorsToInstructions)
			{
